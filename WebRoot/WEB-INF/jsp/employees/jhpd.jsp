...
<body>
    <div class="right" id="mainFrame">
        <div class="right_cont">
			...
			<a href="add.action" class="btn btn-info" style="width:60px;">排号</a>
			<a href="remove.action" class="btn btn-info" style="width:60px;">移号</a>
			<a href="clear.action" class="btn btn-info" style="width:60px;">关闭功能</a>
			</div>
            <div style="width:99%; margin:auto">
				...
				<table class="table table-bordered table-striped table-hover">
					<tbody>
         			...
         			<c:forEach items="${sessionScope.list}" var="list" varStatus="id">
						<tr align="left">
							<td>${list}</td>
         				</tr>
         			</c:forEach>

					...
					<tbody>
         			...
         			<c:forEach items="${orders}" var="o">
						<tr align="left">
							...
							<td>￥${o.price}</td>
							<td>
								<a  href="${pageContext.request.contextPath}/order/waiterOrderDetails.action?id=${o.id }" class="btn btn-info" style="width:80px;">查看订单详情</a>							
							</td>
							<td>
								<a href="${pageContext.request.contextPath}/user/lookUser.action?id=${o.userid }" class="btn btn-info" style="width:80px;">查看顾客详情</a>
							</td>
							<td>
								<a href="${pageContext.request.contextPath}/order/jiezhang.action?id=${o.id }" class="btn btn-info" style="width:80px;">已结账</a>
							</td>
         				</tr>
         			</c:forEach>
					</tbody>

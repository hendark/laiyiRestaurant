		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<c:choose>
					...
					<c:otherwise>
						<div class="shop_hd_topNav_all_left">
							<p>您好，欢迎来到<b><a href="/">来怡饭店</a></b>[<a href="${pageContext.request.contextPath}/user/userLogin.action">登录</a>]
							[<a href="${pageContext.request.contextPath}/user/toregister.action">注册</a>]</p>
						</div>
					</c:otherwise>	
				</c:choose>

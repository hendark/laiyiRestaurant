	...
	<div class="shop_member_bd clearfix">
		...
		<div class="shop_member_bd_left clearfix">
			...
			<dl>
				...
				<dd><span><a href="#">完善个人资料</a></span></dd>
			</dl>
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form ">
					<form action="myInfoUpd.action"  class="shop_form" method="post">
						<ul>
							<li><label>用户名称：</label><input type="text" class="truename form-text" name="username" value="${myuser.username }"/></li>
							<c:choose>
								<c:when test="${myuser.sex==1 }">
									<li><label>性别:</label>
										<input type="radio" checked="checked" class="ml10 mr5" name="sex" value="1" />男
										<input type="radio" class="ml10 mr5" name="sex" value="0" />女
									</li>
								</c:when>
								<c:otherwise>
									<li><label>性别:</label>
										<input type="radio" class="ml10 mr5" name="sex" value="1" />男
										<input type="radio" checked="checked" class="ml10 mr5" name="sex" value="0" />女
									</li>
								</c:otherwise>
							</c:choose>
							<li><label>年龄：</label><input type="text" class="truename form-text" name="age" value="${myuser.age }"/></li>
							<li><label>电话：</label><input type="text" class="truename form-text" name="tel" value="${myuser.tel }"/></li>

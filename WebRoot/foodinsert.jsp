...
<body>
    <div class="right" id="mainFrame">
        <div class="right_cont">
            ...
            <form action="${pageContext.request.contextPath}/food/foodadd.action" method="post">
	            <div style="width:900px; margin:auto">
	                <table class="table table-bordered">
	                    ...
	                    <tr>
	                        ...
	                        <td><input type="text" name="furl" id="input3" class="span1-1" /></td>
	                    ...
	                    <tr>
	                        ...
	                        <td><input type="text" name="fprice" id="input2" class="span1-1" /></td>
	                        <td align="right" bgcolor="#f1f1f1">折扣价：</td>
	                        <td><input type="text" name="fdprice" id="input5" class="span1-1" /></td>
	                    </tr>  
	                    <tr>
